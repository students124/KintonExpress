 ...
 * @author iolux
 */
public class ListBarangPengirim extends javax.swing.JFrame implements ActionListener, ListSelectionListener{
     ...
     */
    public ListBarangPengirim() throws ClassNotFoundException, SQLException {
        initComponents();
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == this.jButton1){
            try {
                ...
                Logger.getLogger(ListBarangPengirim.class.getName()).log(Level.SEVERE, null, ex);
            }
